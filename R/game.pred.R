...
cat("N/A for this object.\n\n")}else{
cat(paste("Predicted score for ",home,": ",round(exp(res$p.mean[match("LocationHome",names(res$p.mean))]+res$p.ratings.offense[match(home,names(res$p.ratings.offense))]-res$p.ratings.defense[match(away,names(res$p.ratings.defense))]),2),"\n",sep=""))
cat(paste("Predicted score for ",away,": ",round(exp(res$p.mean[match("LocationAway",names(res$p.mean))]+res$p.ratings.offense[match(away,names(res$p.ratings.offense))]-res$p.ratings.defense[match(home,names(res$p.ratings.defense))]),2),"\n",sep=""))
cat("\n")
}
...
if(is.null(res$p.ratings.offense)){
cat("N/A for this object.\n\n")}else{
cat(paste("Predicted score for ",home,": ",round(exp(res$p.mean[match("LocationNeutral Site",names(res$p.mean))]+res$p.ratings.offense[match(home,names(res$p.ratings.offense))]-res$p.ratings.defense[match(away,names(res$p.ratings.defense))]),2),"\n",sep=""))
cat(paste("Predicted score for ",away,": ",round(exp(res$p.mean[match("LocationNeutral Site",names(res$p.mean))]+res$p.ratings.offense[match(away,names(res$p.ratings.offense))]-res$p.ratings.defense[match(home,names(res$p.ratings.defense))]),2),"\n",sep=""))
cat("\n")
}
cat("Binary Distribution for Outcomes:\n")
if(is.null(res$b.ratings)){
...
if(is.null(res$p.ratings.offense)){
cat("N/A for this object.\n\n")}else{
cat(paste("Predicted score for ",home,": ",round(exp(res$p.mean[1]+res$p.ratings.offense[match(home,names(res$p.ratings.offense))]-res$p.ratings.defense[match(away,names(res$p.ratings.defense))]),2),"\n",sep=""))
cat(paste("Predicted score for ",away,": ",round(exp(res$p.mean[1]+res$p.ratings.offense[match(away,names(res$p.ratings.offense))]-res$p.ratings.defense[match(home,names(res$p.ratings.defense))]),2),"\n",sep=""))
cat("\n")
}
cat("Binary Distribution for Outcomes:\n")
if(is.null(res$b.ratings)){
